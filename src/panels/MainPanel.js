...
import { setActiveQuiz, setNotifications } from "../store/data/actions";
        ...
        {participantInfo !== null && participantInfo !== "error" && (
          <div>
            <div className="d-row">
              ...
              <div>
                ...
                <Text className="profile__link" weight="regular">
                  <Link onClick={() => router.pushModal(MODAL_PAY)}>
                    Баллов 12. Вывести?
                  </Link>
                </Text>
              </div>
            ...
            <Div className="group-quiz">
              <Group
                mode="plain"
                header={<Header mode="secondary">Доступные опросы</Header>}
              >
                <CardGrid size="l">
