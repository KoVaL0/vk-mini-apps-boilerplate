          ...
          >
            {this.props.data.quiz.length > 0 ? (
              ...
              <Placeholder
                ...
                header="Упс, опросы кончились"
              >
                {!this.props.notifications
                  ? "Опросов пока нет, включите уведомления, чтобы пройти их одним из первых!"
                  : "Опросов пока нет, ожидайте уведомления о появлении новых опросов!"}
              </Placeholder>
            )}
          </Group>
        ) : (
